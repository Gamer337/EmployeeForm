(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/common/http'), require('rxjs'), require('rxjs/operators'), require('fast-sha256')) :
    typeof define === 'function' && define.amd ? define('angular-oauth2-oidc', ['exports', '@angular/core', '@angular/common', '@angular/common/http', 'rxjs', 'rxjs/operators', 'fast-sha256'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['angular-oauth2-oidc'] = {}, global.ng.core, global.ng.common, global.ng.common.http, global.rxjs, global.rxjs.operators, global.fsha256));
}(this, (function (exports, core, common, http, rxjs, operators, fsha256) { 'use strict';

    function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

    var fsha256__default = /*#__PURE__*/_interopDefaultLegacy(fsha256);
    ...
    ***************************************************************************** */
    ...
    var SystemDateTimeProvider = /** @class */ (function (_super) {
        __extends(SystemDateTimeProvider, _super);
        function SystemDateTimeProvider() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        SystemDateTimeProvider.prototype.now = function () {
            return Date.now();
        };
        SystemDateTimeProvider.prototype.new = function () {
            return new Date();
        };
        return SystemDateTimeProvider;
    }(DateTimeProvider));
    SystemDateTimeProvider.decorators = [
    ...
    var DefaultHashHandler = /** @class */ (function () {
        ...
        DefaultHashHandler.prototype.calcHash = function (valueToHash, algorithm) {
            return __awaiter(this, void 0, void 0, function () {
                var candHash;
                return __generator(this, function (_a) {
                    candHash = encodeUTF8(fsha256__default['default'](decodeUTF8(valueToHash)));
                    // const hashArray = (sha256 as any).array(valueToHash);
                    // // const hashString = this.toHashString(hashArray);
                    // const hashString = this.toHashString2(hashArray);
                    // console.debug('hash orig - cand', candHash, hashString);
                    // alert(1);
                    return [2 /*return*/, candHash];
                });
            });
        };
    ...
    var OAuthService = /** @class */ (function (_super) {
        ...
        function OAuthService(ngZone, http, storage, tokenValidationHandler, config, urlHelper, logger, crypto, document, dateTimeService) {
            ...
            _this.discoveryDocumentLoaded$ =
                _this.discoveryDocumentLoadedSubject.asObservable();
        ...
        OAuthService.prototype.setupAutomaticSilentRefresh = function (params, listenTo, noPrompt) {
            ...
            }), operators.filter(function (e) { return e.type === 'token_expires' &&
                (listenTo == null || listenTo === 'any' || e.info === listenTo); }), operators.debounceTime(1000))
        ...
        OAuthService.prototype.clearAutomaticRefreshTimer = function () {
        ...
        OAuthService.prototype.loadDiscoveryDocument = function (fullUrl) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                _this.http.get(fullUrl).subscribe(function (doc) {
                    ...
                    _this.revocationEndpoint =
                        doc.revocation_endpoint || _this.revocationEndpoint;
        ...
        OAuthService.prototype.loadUserProfile = function () {
            ...
            return new Promise(function (resolve, reject) {
                ...
                _this.http
                    .get(_this.userinfoEndpoint, {
                    headers: headers,
                    observe: 'response',
                    responseType: 'text',
                })
                    .subscribe(function (response) {
                    _this.debug('userinfo received', JSON.stringify(response));
                    if (response.headers
                        .get('content-type')
                        ...
                        _this.debug('userinfo is not JSON, treating it as JWE/JWS');
                        _this.eventsSubject.next(new OAuthSuccessEvent('user_profile_loaded'));
         ...
         * @param headers Optional additional HTTP headers.
         */
        OAuthService.prototype.fetchTokenUsingGrant = function (grantType, parameters, headers) {
            var e_1, _b, e_2, _c;
            var _this = this;
            if (headers === void 0) { headers = new http.HttpHeaders(); }
            ...
            if (this.customQueryParams) {
                try {
                    for (var _d = __values(Object.getOwnPropertyNames(this.customQueryParams)), _e = _d.next(); !_e.done; _e = _d.next()) {
                        var key = _e.value;
            ...
            try {
                ...
                for (var _f = __values(Object.keys(parameters)), _g = _f.next(); !_g.done; _g = _f.next()) {
                    var key = _g.value;
            ...
            return new Promise(function (resolve, reject) {
                _this.http
                    ...
                    if (_this.oidc && tokenResponse.id_token) {
                        _this.processIdToken(tokenResponse.id_token, tokenResponse.access_token).then(function (result) {
                    ...
                    _this.logger.error('Error performing ${grantType} flow', err);
            ...
            return this.createLoginUrl(null, null, this.silentRefreshRedirectUri, false, {
                ...
                return new Promise(function (resolve, reject) {
                    ...
                    if (!options.windowRef) {
                        windowRef = window.open(url, 'ngx-oauth2-oidc-login', _this.calculatePopupFeatures(options));
                    }
        ...
        OAuthService.prototype.fetchAndProcessToken = function (params, options) {
            var _this = this;
            options = options || {};
            this.assertUrlNotNullAndCorrectProtocol(this.tokenEndpoint, 'tokenEndpoint');
            var headers = new http.HttpHeaders().set('Content-Type', 'application/x-www-form-urlencoded');
            ...
            return new Promise(function (resolve, reject) {
                ...
                _this.http
                    ...
                    _this.storeAccessTokenResponse(tokenResponse.access_token, tokenResponse.refresh_token, tokenResponse.expires_in ||
                        _this.fallbackAccessTokenExpirationTimeInSec, tokenResponse.scope, _this.extractRecognizedCustomParameters(tokenResponse));
                    if (_this.oidc && tokenResponse.id_token) {
                        _this.processIdToken(tokenResponse.id_token, tokenResponse.access_token, options.disableNonceCheck)
        ...
        OAuthService.prototype.getClockSkewInMsec = function (defaultSkewMsc) {
            if (defaultSkewMsc === void 0) { defaultSkewMsc = 600000; }
        ...
        OAuthService.prototype.logOut = function (customParameters, state) {
            ...
            if (this.logoutUrl.indexOf('{{') > -1) {
                ...
                var postLogoutUrl = this.postLogoutRedirectUri ||
         ...
         */
        OAuthService.prototype.clearLocationHash = function () {
    ...
    var DefaultOAuthInterceptor = /** @class */ (function () {
        ...
        DefaultOAuthInterceptor.prototype.checkUrl = function (url) {
            ...
            if (this.moduleConfig.resourceServer.allowedUrls) {
                return !!this.moduleConfig.resourceServer.allowedUrls.find(function (u) { return url.toLowerCase().startsWith(u.toLowerCase()); });
            }
            return true;
        };
        DefaultOAuthInterceptor.prototype.intercept = function (req, next) {
            ...
            return rxjs.merge(rxjs.of(this.oAuthService.getAccessToken()).pipe(operators.filter(function (token) { return !!token; })), this.oAuthService.events.pipe(operators.filter(function (e) { return e.type === 'token_received'; }), operators.timeout(this.oAuthService.waitForTokenInMsec || 0), operators.catchError(function (_) { return rxjs.of(null); }), // timeout is not an error
    ...
    exports.DefaultHashHandler = DefaultHashHandler;
    ...
    exports.SystemDateTimeProvider = SystemDateTimeProvider;
    exports.UrlHelperService = UrlHelperService;
    exports.ValidationHandler = ValidationHandler;
    exports.ɵa = createDefaultLogger;
    exports.ɵb = createDefaultStorage;
